                ...
                for (int m = 0; m < vertexsOfFace[i].size(); m++) {
                    for (int n = 0; n < vertexsOfFace[j].size(); n++) {
                        if (vertexsOfFace[i][m] == vertexsOfFace[j][n] &&
                            (faces[vertexsOfFace[i][m]]->d1 == 0 ||
                             !((faces[vertexsOfFace[i][m]]->a1 == i + 1 && faces[vertexsOfFace[j][n]]->c1 == j + 1)
            ...
            else
            {
                if (faces[i]->d1 == 0)
                {
                    ...
                    if (faces[i]->a1 == index.first)
                    {
                        ...
                        vertexsOfFace[index.second - 1].push_back(i);
                        continue;
                    }
                    if (faces[i]->b1 == index.first)
                    {
                ...
                else
                {
                    ...
                    if (faces[i]->a1 == index.first)
                    {
                        ...
                        vertexsOfFace[tmpf->a1 - 1].push_back(faces.size() - 1);
                        vertexsOfFace[tmpf->b1 - 1].push_back(faces.size() - 1);
                        vertexsOfFace[tmpf->c1 - 1].push_back(faces.size() - 1);
                        continue;
                    }
                    if (faces[i]->b1 == index.first)
                    {
...
int main() {
    ...
    cout << "Simply time:" << (double)(end_t - start_t) / CLOCKS_PER_SEC << "s\n";
